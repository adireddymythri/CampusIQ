  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      if (data.ok) {
        ...
        setTimeout(
          () =>
            navigate(documentType === "paper" ? "/app/papers" : "/app/notes"),
          2000,
        );
      }
    } catch (err) {
      ...
      setError(msg);
      if (
        err?.response?.data?.code === "DUPLICATE_FILE" ||
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-slate-400 ml-14">
              Add your notes and organize them easily
            </p>
          </div>
          ...
          {success ? (
            <div className="text-center py-10">
              ...
              <p className="text-slate-400 mt-2">
                Your notes have been uploaded and are being processed.
              </p>
              ...
              <div className="relative">
                ...
                <div className="relative max-w-[250px]">
                  ...
                  >
                    ...
                    <option value="paper" className="bg-slate-900">
                      Previous Question Paper
                    </option>
                  </select>
                  <svg
                    className="absolute right-3 top-4 size-4 text-slate-400 pointer-events-none"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
                  ...
                  <div className="relative group">
                    ...
                    <div className="border-2 border-dashed border-white/10 group-hover:border-indigo-500/50 rounded-2xl p-10 flex flex-col items-center justify-center transition-all bg-white/[0.02]">
                      ...
                      <p className="text-xs text-slate-500">
                        PDF or Word documents up to 25MB
                      </p>
                    </div>
                  </div>
                ) : (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <option value="Unit-1" className="bg-slate-900">
                      Unit-1
                    </option>
                    <option value="Unit-2" className="bg-slate-900">
                      Unit-2
                    </option>
                    <option value="Unit-3" className="bg-slate-900">
                      Unit-3
                    </option>
                    <option value="Unit-4" className="bg-slate-900">
                      Unit-4
                    </option>
                    <option value="Unit-5" className="bg-slate-900">
                      Unit-5
                    </option>
                    <option value="Full Syllabus" className="bg-slate-900">
                      Full Syllabus
                    </option>
                  </select>
                  <svg
                    className="absolute right-3 top-11 size-4 text-slate-400 pointer-events-none"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
