...
export function PracticePage() {
  ...
  const [userAnswers, setUserAnswers] = useState({}); // maps questionId -> selectedOptionIndex
  const [markedQuestions, setMarkedQuestions] = useState({}); // maps questionId -> boolean
  ...
  const handleSubmitQuiz = async (answersOverride) => {
                  ...
                  <div className="lg:col-span-7 bg-[#0c112b] border border-white/5 rounded-3xl p-6 shadow-xl relative overflow-hidden backdrop-blur flex flex-col justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 mb-6 leading-relaxed">
                        Select one of your uploaded PDF documents below, and our
                        AI will immediately synthesize structured,
                        multiple-choice testing materials.
                      </p>
                      ...
                      {loadingNotes ? (
                        ...
                        <div className="text-center py-10 bg-white/5 border border-white/5 rounded-2xl p-6">
                          ...
                          <p className="text-xs text-slate-500 mt-1 max-w-xs mx-auto mb-4">
                            You need to upload at least one study material note
                            before you can generate practice tests.
                          </p>
                          <Link
                            to="/app/upload"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              >
                                ...
                                <span className="text-[10px] text-slate-500 mt-1 leading-relaxed">
                                  No timers. Perfect for learning at your own
                                  pace with instant answer reveals.
                                </span>
                              </button>
                              ...
                              >
                                ...
                                <span className="text-[10px] text-slate-500 mt-1 leading-relaxed">
                                  Simulates exam conditions. A ticking clock
                                  forces rapid critical reasoning.
                                </span>
                              </button>
                            </div>
                          </div>
                  ...
                  <div className="lg:col-span-5 bg-[#0a0d20]/60 border border-white/5 rounded-3xl p-6 shadow-xl backdrop-blur relative overflow-hidden flex flex-col justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 mb-6">
                        Track your performance and secure valuable XP
                        incentives.
                      </p>
                      ...
                      <div className="mt-6 space-y-4">
                        <div className="flex items-center gap-3 bg-[#11142e] border border-white/5 rounded-2xl p-4">
                          ...
                          <div>
                            ...
                            <span className="text-[10px] text-slate-400 leading-normal block">
                              AI auto-tunes question complexities based on your
                              note text and past scores.
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 bg-[#11142e] border border-white/5 rounded-2xl p-4">
                          ...
                          <div>
                            ...
                            <span className="text-[10px] text-slate-400 leading-normal block">
                              Receive elaborate breakdowns and answers instantly
                              to study from.
                            </span>
                          </div>
                        </div>
                    ...
                    <div className="mt-8 border-t border-white/5 pt-4 text-center">
                      <span className="text-[10px] text-slate-500 leading-relaxed block">
                        All quizzes generated are registered on your profile.
                        Retaking tests can continuously hone your retention and
                  ...
                  {loadingHistory ? (
                    ...
                    <div className="text-center py-12 bg-[#0c112b]/30 border border-white/5 rounded-3xl">
                      <p className="text-sm text-slate-500 font-medium">
                        You haven't generated any quizzes yet. Start one above!
                      </p>
                    </div>
                  ) : (
                      ...
                      {quizzes.map((q) => (
                        ...
                        >
                          <div>
                            ...
                            <h3 className="font-bold text-white text-sm mt-3 group-hover:text-indigo-400 transition-colors line-clamp-1">
                              {q.title}
                            </h3>
                            ...
                            {q.bestScore && (
                              <p className="text-[10px] mt-1.5 font-bold">
                                <span
                                  className={
                                    q.bestScore.score / q.bestScore.total >= 0.7
                                      ? "text-emerald-400 bg-emerald-400/10 px-2 py-0.5 rounded"
                                      : "text-amber-400 bg-amber-400/10 px-2 py-0.5 rounded"
                                  }
                                >
                                  Best Score: {q.bestScore.score} /{" "}
                                  {q.bestScore.total}
                                </span>
                              </p>
                            )}
                ...
                <div className="lg:col-span-4 bg-[#0a0d1d] border border-white/5 rounded-3xl p-5 shadow-xl relative overflow-hidden backdrop-blur">
                  ...
                  <div className="bg-[#0e122b] border border-white/5 rounded-2xl p-6 text-center shadow-inner relative overflow-hidden group">
                    ...
                    <div className="flex items-center justify-center gap-3 mt-3">
                      <Clock
                        className={`size-6 ${activeQuiz.mode === "timed" && timeLeftSec < 60 ? "text-rose-400 animate-pulse" : "text-indigo-400"}`}
                      />
                      <span
                        className={`text-3xl font-black tracking-wider leading-none font-mono ${
                          activeQuiz.mode === "timed"
                            ? timeLeftSec < 60
                  ...
                  <div className="mt-5 space-y-3.5">
                    <div className="flex items-center justify-between text-xs font-bold p-3 bg-white/5 rounded-xl border border-white/5">
                      ...
                      <span className="text-white bg-emerald-500/20 px-2 py-0.5 rounded text-[11px]">
                        {answeredCount}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-xs font-bold p-3 bg-white/5 rounded-xl border border-white/5">
                      ...
                      <span className="text-white bg-rose-500/10 px-2 py-0.5 rounded text-[11px]">
                        {notAnsweredCount}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-xs font-bold p-3 bg-white/5 rounded-xl border border-white/5">
                      ...
                      <span className="text-white bg-violet-500/20 px-2 py-0.5 rounded text-[11px]">
                        {markedCount}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 border-t border-white/5 pt-5">
                    ...
                    <div className="grid grid-cols-5 gap-2">
                      {activeQuestions.map((q, idx) => {
                        ...
                        let btnClass =
                          "bg-[#121633] text-slate-400 border border-white/5 hover:border-white/20";
                  ...
                  <button
                    onClick={() => {
                      if (
                        confirm(
                          "Are you sure you want to end this test and submit all answers?",
                        )
                      ) {
                        handleSubmitQuiz();
                      }
                ...
                <div className="lg:col-span-8 bg-[#0c112b] border border-white/5 rounded-3xl p-6 shadow-xl relative overflow-hidden backdrop-blur">
                  ...
                  <div className="flex items-center justify-between pb-4 border-b border-white/5">
                    <span className="bg-[#12183d] text-indigo-400 border border-indigo-500/20 px-3 py-1 rounded-xl text-xs font-bold uppercase tracking-wider">
                      Topic:{" "}
                      {activeQuestions[currentQuestionIndex].topic || "General"}
                    </span>
                    ...
                    <label className="flex items-center gap-2 cursor-pointer select-none group text-xs font-bold text-slate-400 hover:text-slate-200 transition-colors">
                      <input
                        ...
                        checked={
                          markedQuestions[
                            activeQuestions[currentQuestionIndex]._id
                          ] === true
                        }
                        onChange={(e) => {
                          setMarkedQuestions({
                ...
                <div className="bg-[#0c112b] border border-white/5 rounded-3xl p-6 shadow-xl relative overflow-hidden backdrop-blur text-center">
                  ...
                  <div className="relative z-10 flex flex-col items-center">
                    ...
                    <h2 className="text-xl font-bold text-white mt-5">
                      Practice Quiz Finalized!
                    </h2>
                    <p className="text-xs text-slate-400 mt-1 max-w-sm">
                      Outstanding effort! You've successfully finished taking
                      the test for <strong>{activeQuiz.title}</strong>.
                    </p>
                    ...
                    <div className="mt-5 inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-amber-500/10 via-yellow-500/20 to-amber-500/10 border border-amber-500/30 text-amber-300 font-bold text-sm shadow-lg shadow-amber-500/5 animate-pulse">
                      ...
                      <span>
                        +{quizResults.xpEarned} XP Gained & Added to Profile!
                      </span>
                    </div>
                    ...
                    {quizResults.results.map((res, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Question prompt */}
                          <h4 className="font-bold text-white text-sm mt-4 leading-relaxed">
                            {res.prompt}
                          </h4>
                          ...
                          <div className="mt-4 space-y-2.5">
                            {res.options.map((opt, optIdx) => {
                              const isStudentSelected =
                                res.selectedOptionIndex === optIdx;
                              const isCorrect =
                                res.correctOptionIndex === optIdx;
                              ...
                              if (isCorrect) {
                                ...
                                optClass =
                                  "bg-rose-500/10 border border-rose-500/30 text-rose-300 font-medium";
                              }
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <span>{opt.text}</span>
                                  {isCorrect && (
                                    <span className="ml-auto text-[9px] font-bold uppercase tracking-wider bg-emerald-500/20 text-emerald-400 px-1.5 py-0.5 rounded">
                                      Correct Choice
                                    </span>
                                  )}
                                  {isStudentSelected && !isCorrect && (
                                    <span className="ml-auto text-[9px] font-bold uppercase tracking-wider bg-rose-500/20 text-rose-400 px-1.5 py-0.5 rounded">
                                      Your Choice
                                    </span>
                                  )}
                                </div>
